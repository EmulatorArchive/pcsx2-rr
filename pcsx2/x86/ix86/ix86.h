...
extern void MOV32RmStoR( x86IntRegType to, x86IntRegType from, x86IntRegType from2, int scale );
// mov [imm32(from2) + r32(from1)<<scale] to r32 
extern void MOV32RmSOffsettoR( x86IntRegType to, x86IntRegType from1, int from2, int scale );
// mov r32 to [r32] 
extern void MOV32RtoRm( x86IntRegType to, x86IntRegType from );
// mov r32 to [r32][r32*scale]
extern void MOV32RtoRmS( x86IntRegType to, x86IntRegType from, x86IntRegType from2, int scale );
// mov imm32 to r32 
extern void MOV32ItoR( x86IntRegType to, u32 from );
// mov imm32 to m32 
extern void MOV32ItoM( uptr to, u32 from );
// mov imm32 to [r32+off]
extern void MOV32ItoRmOffset( x86IntRegType to, u32 from, int offset);
// mov r32 to [r32+off]
extern void MOV32RtoRmOffset( x86IntRegType to, x86IntRegType from, int offset);
...
extern void MOV16RmtoROffset( x86IntRegType to, x86IntRegType from, int offset );
// mov [imm32(from2) + r32(from1)<<scale] to r16 
extern void MOV16RmSOffsettoR( x86IntRegType to, x86IntRegType from1, u32 from2, int scale );
// mov r16 to [r32]
extern void MOV16RtoRm(x86IntRegType to, x86IntRegType from);
// mov imm16 to m16 
extern void MOV16ItoM( uptr to, u16 from );
/* mov r16 to [r32][r32*scale] */
extern void MOV16RtoRmS( x86IntRegType to, x86IntRegType from, x86IntRegType from2, int scale);
// mov imm16 to r16
extern void MOV16ItoR( x86IntRegType to, u16 from );
// mov imm16 to [r16+off]
extern void MOV16ItoRmOffset( x86IntRegType to, u16 from, u32 offset);
// mov r16 to [r16+off]
extern void MOV16RtoRmOffset( x86IntRegType to, x86IntRegType from, int offset);
...
extern void MOV8RmtoROffset(x86IntRegType to, x86IntRegType from, int offset);
extern void MOV8RmSOffsettoR( x86IntRegType to, x86IntRegType from1, u32 from2, int scale );
// mov r8 to [r32]
extern void MOV8RtoRm(x86IntRegType to, x86IntRegType from);
// mov imm8 to m8 
extern void MOV8ItoM( uptr to, u8 from );
// mov imm8 to r8
extern void MOV8ItoR( x86IntRegType to, u8 from );
// mov imm8 to [r8+off]
extern void MOV8ItoRmOffset( x86IntRegType to, u8 from, int offset);
// mov r8 to [r8+off]
extern void MOV8RtoRmOffset( x86IntRegType to, x86IntRegType from, int offset);

// movsx r8 to r32 
extern void MOVSX32R8toR( x86IntRegType to, x86IntRegType from );
extern void MOVSX32Rm8toR( x86IntRegType to, x86IntRegType from );
extern void MOVSX32Rm8toROffset( x86IntRegType to, x86IntRegType from, int offset );
// movsx m8 to r32 
extern void MOVSX32M8toR( x86IntRegType to, u32 from );
// movsx r16 to r32 
extern void MOVSX32R16toR( x86IntRegType to, x86IntRegType from );
extern void MOVSX32Rm16toR( x86IntRegType to, x86IntRegType from );
extern void MOVSX32Rm16toROffset( x86IntRegType to, x86IntRegType from, int offset );
// movsx m16 to r32 
extern void MOVSX32M16toR( x86IntRegType to, u32 from );

// movzx r8 to r32 
extern void MOVZX32R8toR( x86IntRegType to, x86IntRegType from );
extern void MOVZX32Rm8toR( x86IntRegType to, x86IntRegType from );
extern void MOVZX32Rm8toROffset( x86IntRegType to, x86IntRegType from, int offset );
// movzx m8 to r32 
extern void MOVZX32M8toR( x86IntRegType to, u32 from );
// movzx r16 to r32 
extern void MOVZX32R16toR( x86IntRegType to, x86IntRegType from );
extern void MOVZX32Rm16toR( x86IntRegType to, x86IntRegType from );
...
// add imm32 to r64 
extern void ADD64ItoR( x86IntRegType to, u32 from );
// add m64 to r64 
...
extern void ADD32ItoRmOffset( x86IntRegType to, u32 from, int offset);
// add r32 to r32 
...
// add imm16 to r16 
extern void ADD16ItoR( x86IntRegType to, u16 from );
// add imm16 to m16 
extern void ADD16ItoM( uptr to, u16 from );
// add r16 to m16 
...
// sub m64 to r64 
extern void SUB64MtoR( x86IntRegType to, uptr from );
...
// sbb r64 to r64 
extern void SBB64RtoR( x86IntRegType to, x86IntRegType from );
...
// shl imm8 to r64 
extern void SHL64ItoR( x86IntRegType to, u8 from );
// shl cl to r64
extern void SHL64CLtoR( x86IntRegType to );
// shr imm8 to r64 
extern void SHR64ItoR( x86IntRegType to, u8 from );
// shr cl to r64
extern void SHR64CLtoR( x86IntRegType to );
// sar imm8 to r64 
extern void SAR64ItoR( x86IntRegType to, u8 from );
// sar cl to r64
extern void SAR64CLtoR( x86IntRegType to );
...
// or imm32 to r64 
extern void OR64ItoR( x86IntRegType to, u32 from );
// or m64 to r64 
extern void OR64MtoR( x86IntRegType to, uptr from );
// or r64 to r64
extern void OR64RtoR( x86IntRegType to, x86IntRegType from );
// or r32 to m64
extern void OR64RtoM( uptr to, x86IntRegType from );
...
// xor imm32 to r64 
extern void XOR64ItoR( x86IntRegType to, u32 from );
// xor r64 to r64 
extern void XOR64RtoR( x86IntRegType to, x86IntRegType from );
// xor m64 to r64
extern void XOR64MtoR( x86IntRegType to, uptr from );
// xor r64 to r64
extern void XOR64RtoR( x86IntRegType to, x86IntRegType from );
// xor r64 to m64
extern void XOR64RtoM( uptr to, x86IntRegType from );
// xor imm32 to r32 
...
// and imm32 to r64 
extern void AND64I32toR( x86IntRegType to, u32 from );
// and m64 to r64
extern void AND64MtoR( x86IntRegType to, uptr from );
// and r64 to m64
extern void AND64RtoM( uptr to, x86IntRegType from );
// and r64 to r64
extern void AND64RtoR( x86IntRegType to, x86IntRegType from );
// and imm32 to m64
extern void AND64I32toM( uptr to, u32 from );
...
// not r64 
extern void NOT64R( x86IntRegType from );
// not r32 
extern void NOT32R( x86IntRegType from );
// not m32 
extern void NOT32M( u32 from );
// neg r64 
extern void NEG64R( x86IntRegType from );
// neg r32 
...
// cmp imm32 to r64 
extern void CMP64I32toR( x86IntRegType to, u32 from );
// cmp m64 to r64 
extern void CMP64MtoR( x86IntRegType to, uptr from );
// cmp r64 to r64 
extern void CMP64RtoR( x86IntRegType to, x86IntRegType from );
...
extern void CMP32I8toRmOffset8( x86IntRegType to, u8 from, u8 off);
// cmp imm8 to [r32]
...
// to = from + offset
extern void LEA16RtoR(x86IntRegType to, x86IntRegType from, u16 offset);
extern void LEA32RtoR(x86IntRegType to, x86IntRegType from, u32 offset);
